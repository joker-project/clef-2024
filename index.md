...
Humor involves complex linguistic phenomena, such as wordplay, irony, sarcasm, and puns. Automatic humor classification helps in developing more sophisticated language models and conversational agents that can engage in humorous interactions and generate humorous content. Humor can often be used as a tool to convey sentiments or emotions. Automatic humor classification can help analyze the sentiment behind humorous content, distinguishing between positive, negative, or neutral humor. This information can be valuable for sentiment analysis applications, such as understanding user sentiment in social media posts, customer reviews, or public opinions. Automatic humor classification helps in filtering out content that may be offensive, inappropriate, or simply not enjoyable for certain individuals or groups. The test collection will be also valuable for digital humanities, humor research and second language learners.
<br>
